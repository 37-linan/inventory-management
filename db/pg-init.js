...
const migrationSQL = `
  ...
  -- 添加套组数量字段（抖音刷券专用，默认1）
  ALTER TABLE main_products ADD COLUMN IF NOT EXISTS bundle_qty INTEGER DEFAULT 1;
  ALTER TABLE douyin_products ADD COLUMN IF NOT EXISTS bundle_qty INTEGER DEFAULT 1;
`;
